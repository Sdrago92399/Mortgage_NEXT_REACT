        ...
        <AnimatePresence mode="wait">
          ...
          >
            {cardData[selectedTab].map((card, index) => (
              ...
              href={card.link} 
              key={card.title}
              className={`flex rounded cursor-pointer flex-col gap-8 bg-[rgb(240,247,241)] px-8 py-5 md:flex-row md:gap-10 md:justify-between md:px-12 md:py-8 lg:flex-1 lg:flex-col lg:basis-1/4 lg:justify-between lg:gap-6 lg:px-12 lg:py-[35px] ${
                index === 0 ? "max-w-[380px] flex-shrink-0" : "w-full flex-grow"
              }`}
              >
                <motion.div
